...

{
  ...
  options = {
    ...
    networking.nat.externalInterfaces = mkOption {
      type = types.listOf types.str;
      default = [ ];
      example = [
        "eth0"
      ...
      description = ''
        The name of the external network interfaces.
      '';
    };
  ...
  config = mkIf config.networking.nat.enable {
    ...
    networking.nat.externalInterfaces = optional (cfg.externalInterface != null) cfg.externalInterface;
